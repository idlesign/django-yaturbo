# -*- coding: utf-8 -*-
#
# django-yaturbo documentation build configuration file.
#
...
copyright = u'2018-2022, Igor `idle sign` Starikov'
...
htmlhelp_basename = 'django-yaturbodoc'
...
latex_documents = [
  ('index', 'django-yaturbo.tex', u'django-yaturbo Documentation',
...
man_pages = [
    ('index', 'django-yaturbo', u'django-yaturbo Documentation',
